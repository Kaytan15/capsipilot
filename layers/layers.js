...
//ol.proj.get("EPSG:3857").setExtent([3112356.311923, -2995299.197847, 3129752.549002, -2987493.610127]);
var wms_layers = [];
...
var format_SP_NAMEGT_4 = new ol.format.GeoJSON();
var features_SP_NAMEGT_4 = format_SP_NAMEGT_4.readFeatures(json_SP_NAMEGT_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_SP_NAMEGT_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_SP_NAMEGT_4.addFeatures(features_SP_NAMEGT_4);
var lyr_SP_NAMEGT_4 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_SP_NAMEGT_4, 
                style: style_SP_NAMEGT_4,
                popuplayertitle: "SP_NAME GT",
                interactive: true,
                    title: '<img src="styles/legend/SP_NAMEGT_4.png" /> SP_NAME GT'
                });

lyr_GOogelsatalitehybrid_0.setVisible(true);lyr_Googlemaps_1.setVisible(false);lyr_DaveytonSPpilotareas_2.setVisible(true);lyr_Diepslootpilotareas_3.setVisible(true);lyr_SP_NAMEGT_4.setVisible(true);
var layersList = [lyr_GOogelsatalitehybrid_0,lyr_Googlemaps_1,lyr_DaveytonSPpilotareas_2,lyr_Diepslootpilotareas_3,lyr_SP_NAMEGT_4];
...
lyr_SP_NAMEGT_4.set('fieldAliases', {'id': 'id', 'SP_NAME': 'SP_NAME', });
...
lyr_SP_NAMEGT_4.set('fieldImages', {'id': 'TextEdit', 'SP_NAME': 'TextEdit', });
...
lyr_SP_NAMEGT_4.set('fieldLabels', {'id': 'no label', 'SP_NAME': 'no label', });
lyr_SP_NAMEGT_4.on('precompose', function(evt) {
